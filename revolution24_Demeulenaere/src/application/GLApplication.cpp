...
GLApplication::GLApplication() {
  leftPanelMenu_ << "Tetrahedron" << "Sphere" << "Revolution" << "" << "Ambient" << "Light" << "Texture" << "" << "Input Profile" << "" << "Fill" << "Line";
...
void GLApplication::drawScene() {
  ...
  revolution_.draw(shaderMode_,isFill_);
...
void GLApplication::draw() {
  switch (requestInit_) {
  case Init_Tetrahedron:revolution_.initTetrahedron();break;
...
void GLApplication::leftPanel(size_t i,const std::string &) {
  ...
  switch(i) {
  case 0:requestInit_=Init_Tetrahedron;break;
  case 1:requestInit_=Init_Sphere;break;
  ...
  case 10:isFill_=true;break;
  case 11:isFill_=false;break;
  }
}
