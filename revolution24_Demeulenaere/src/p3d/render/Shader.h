...
namespace p3d {
  ...
  public:
    ...
    void uniform(const std::string &nom, const std::vector<float> &t);
    void uniform(int loc, const std::vector<float> &t);
    ...
    void uniform(int loc, const std::vector<Vector2> &v);
    void uniform(const std::string &name, const std::vector<Vector2> &v);
