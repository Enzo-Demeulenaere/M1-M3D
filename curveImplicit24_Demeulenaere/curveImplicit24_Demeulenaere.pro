...
INCLUDEPATH += src/p3d src/p3d/glad/ src/application/ src/p3d/algebra/ src/p3d/render/ src/p3d/gui/ src/p3d/scene/ 
DEPENDPATH += src/p3d/glad/ src/application/ src/p3d/algebra/ src/p3d/render/ src/p3d/gui/ src/p3d/scene/ 
...
SOURCES += \
	...
	src/application/Grid.cpp \
	src/application/Implicit.cpp \
	src/application/Blob.cpp \
...
HEADERS += \
	...
	src/application/Grid.h \
	src/application/Implicit.h \
	src/application/Blob.h \
	src/p3d/gui/GLWidget.h \
	src/p3d/gui/MainWindow.h
OTHER_FILES +=\
	media/shader/implicit.frag\
	media/shader/implicit.vert
